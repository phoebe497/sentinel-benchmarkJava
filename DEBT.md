...
- Repoint the existing Streamlit Community Cloud app from the legacy repository to `phoebe497/sentinel-benchmarkJava`, entrypoint `app/streamlit_app.py`, and make mentor access public. The legacy URL currently redirects to Streamlit login.
